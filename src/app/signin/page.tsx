			...
			<div className="max-w-md w-full relative z-10">
				...
				<div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8">
					...
					<button
						...
						className="w-full mb-6 bg-white text-gray-800 py-3 px-4 rounded-lg font-medium hover:bg-gray-100 transition flex items-center justify-center gap-3 border border-gray-300"
					>
