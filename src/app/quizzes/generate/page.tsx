	...
	if (showPreview) {
		return (
			<div className="relative min-h-screen overflow-hidden text-white">
				...
				<div className="fixed -left-32 top-10 -z-10 h-[520px] w-[520px] rounded-full bg-[#FF446D]/18 blur-[140px]" />
				<div className="fixed right-[-140px] top-40 -z-10 h-[500px] w-[500px] rounded-full bg-purple-600/16 blur-[140px]" />
				<div className="fixed left-1/3 bottom-[-140px] -z-10 h-[520px] w-[520px] rounded-full bg-cyan-500/12 blur-[160px]" />
				...
				<div className="relative min-h-screen py-16 px-4">
					<div className="max-w-4xl mx-auto relative z-10">
						...
						{/* Quiz Details Form */}
						<div className="bg-gradient-to-br from-white/[0.07] to-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8 mb-8">
		...
		<div className="relative min-h-screen overflow-hidden text-white">
			...
			<div className="relative min-h-screen py-16 px-4">
				<div className="max-w-4xl mx-auto relative z-10">
						...
						<div className="flex items-center gap-4 mt-6">
							...
							<div>
								...
								<p className="text-white/60 mt-1.5">
									Paste your content or upload a PDF, then let AI craft tailored
									quiz questions.
								</p>
							</div>
						</div>
					...
					{/* Generation Form */}
					<div className="bg-gradient-to-br from-white/[0.07] to-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
						{/* Input Mode Toggle */}
						<div className="mb-8">
						...
						<div className="mb-6 p-4 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
							<p className="text-cyan-200 text-sm">
								💡 <strong>Tip:</strong> AI works best with clear,
								well-structured content. Include key concepts, definitions, and
								examples for better question quality.
							</p>
						</div>
						...
						>
							{generating ? (
								<>
									...
									<span>
										Generating with AI... (this may take 10-15 seconds)
									</span>
								</>
							) : (
								<>
